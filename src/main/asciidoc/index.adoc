...
operation::create-event[snippets='curl-request,links,response-body,http-request,request-body,response-fields,http-response,request-fields,response-headers,httpie-request,request-headers']
